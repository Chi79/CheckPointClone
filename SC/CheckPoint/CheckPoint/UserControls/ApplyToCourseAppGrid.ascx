<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApplyToCourseAppGrid.ascx.cs" Inherits="CheckPoint.Views.UserControls.ApplyToCourseAppGrid" %>
...
@-webkit-keyframes glowingrow{
 ...
 <asp:TemplateField AccessibleHeaderText="IsObligatory" HeaderText="IsObligatory" ItemStyle-CssClass="isObligatoryColumnItem" Visible="false">
 <HeaderTemplate>
 ...
 <asp:TemplateField AccessibleHeaderText="IsPrivate" HeaderText="IsPrivate" ItemStyle-CssClass="isPrivateColumnItem" Visible="false">
 <HeaderTemplate>
