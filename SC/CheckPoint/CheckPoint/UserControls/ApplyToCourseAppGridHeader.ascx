<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ApplyToCourseAppGridHeader.ascx.cs" Inherits="CheckPoint.Views.UserControls.ApplyToCourseAppGridHeader" %>
...
.headertext {
 ...
 <asp:ImageButton 
  ...
  <asp:TemplateField AccessibleHeaderText="IsObligatory" HeaderText="IsObligatory" HeaderStyle-CssClass="isObligatoryHeader" Visible="false">
  <HeaderTemplate>
