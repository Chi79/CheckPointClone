<%@ Page Language="C#" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="ExpiredAppointmentsView.aspx.cs"  Inherits="CheckPoint.Views.ExpiredAppointmentsView"  EnableEventValidation="false"  MasterPageFile="~/HostMaster.Master" %>
...
<asp:Content ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div id="AppointmentHeading" class="Appointmentslide" style="z-index:5"><img src="Images/CompletedAppointmentsHeading1.svg" /></div>
    ...
    <ContentTemplate>
    <asp:Button ID="btnViewAttendancesForAppointment" 
        CssClass="navButtons" 
        runat="server" 
        OnClick="btnViewAttendancesForAppointment_Click"
        Text="View Attendances For Selected Appointment"  
        Visible="True"  
        ForeColor="White"/>
    </ContentTemplate>
    </asp:UpdatePanel>
