<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppointmentSelectorView.aspx.cs" Inherits="CheckPoint.Views.AppointmentSelectorView" EnableEventValidation="false" MasterPageFile="~/HostMaster.Master" %>
...
<asp:Content ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <asp:Button ID="btnAddSelectedAppointmentToCourse" 
        ...
        Text="Add Selected Appointment to the Course"  
        Visible="True" 
        ForeColor="White"/>
    </ContentTemplate>
    </asp:UpdatePanel>
