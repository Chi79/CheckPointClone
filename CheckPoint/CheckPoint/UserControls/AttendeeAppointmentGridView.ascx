<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AttendeeAppointmentGridView.ascx.cs" Inherits="CheckPoint.Views.UserControls.AttendeeAppointmentGridView" %>
