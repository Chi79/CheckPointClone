<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangesSavedView.aspx.cs" Inherits="CheckPoint.Views.ChangesSavedView" %>
...
<body>
    <form id="form1" runat="server" style="background-color:#333333">
       ...
       <div id="panel1" class="parent">
        ...
        <div class="btnBackToAppointmentsView">
        <asp:Button CssClass="navButtons" ID="btnBackToAppointmentsView" runat="server" OnClick="btnBackToAppointmentsView_Click" Text="Back To View Appointments" />
        </div> 
